...
on the same level as the stacked recommenders,
...
In an actual system, the stacked recommenders should be tested
...
\paragraph{Choosing Different Basic Recommenders}
TODO. 
...
In this case, stacked recommenders could be used to adapt
...
By using stacked recommenders we would be able
