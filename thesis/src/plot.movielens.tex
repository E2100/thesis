...
\caption[Average RMSE Plot]{
  Average RMSE plot: This plot shows the average RMSE for the recommenders and the aggregators (denoted ``a:'').
  The actual numbers are given in Table \ref{table:results:e1}.
  The error bars indicate the standard deviation for the methods.
