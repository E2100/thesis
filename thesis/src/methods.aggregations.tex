...
and allowing us to perform it as a $\mathrm{map}$ operation.
...
We have now seen how adaptive prediction and rank aggregation can be performed with stacked user modeling.
The next section will describe our system that implements these algorithms.
This system is used in the next chapter to evaluate the strength of the algorithms in this chapter,
