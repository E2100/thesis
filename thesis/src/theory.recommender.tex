...
Basically, this means averaging the neighborhood ratings weighted by similarity \cite[p16]{Segaran2007}:
...
Other simple measures include the \emph{euclidean distance} \cite[p10]{Segaran2007} or 
matching metrics from information retrieval, as used in the \emph{vector space model} (VSM)
(as explained in section \ref{sec:search}). 
