...
In recommender systems, we can for instance use the resulting reduced factors to find similar users by their cosine similarity (see Section \ref{sec:search}).
