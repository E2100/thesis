...
\begin{figure}[t]
  ...
  \caption[SVD Image Compression]{
    ...
    The original image is on the left, and successive images use an increasing number of factors when performing compression.
    Figure adaptived from \citet[p4]{Ranade2007}.
  }
  \label{fig:svd-image}
\end{figure}
