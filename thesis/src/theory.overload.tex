...
(1) Consuming content that is known by the user to be relevant can be drowned out by irrelevant noise.
(2) At the same time, discovering interesting yet unknown content also becomes difficult because of the sheer amount of available information.
...
The Internet has the properties of a \emph{small-world network} (\citep{Newman2000}, \citep[p2]{Huang2005}), 
...
Factor in the existence of multiple sub-graphs, or continents, on the Web, 
and we can intuitively see that navigating the Web is not as 
