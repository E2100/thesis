...
\begin{axis}[
      symbolic x coords={
        knn,svd2,svd1,slopeone,itemavg,svd4,svd3,cosine,average,a-median,a-average,a-stacked},
      xtick=data,
...
\caption[Average RMSE Plot]{
  ...
  The actual numbers are given in Table \ref{table:results:e1:sum}.
