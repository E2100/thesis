...
algorithms in \emph{artificial intelligence} can not get enough.
...
While their name might seem constraining, recommender systems are incredibly powerful tools.
...
Modern aggregation approaches to recommendations face the same problem: 
...
While the aggregation is properly selected to minimize some error over a testing set,
...
where these decisions are left to each user and item.
