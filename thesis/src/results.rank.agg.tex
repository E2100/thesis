...
The implications of adaptive rankings of search results are not hard to see.
...
each item is sorted by the algorithms that can best predict their relevance.

This is the main strenght of adaptive recommenders.
Instead of a generic and averaged sorting, we achieve an adaptive sorting
that creates an optimal algorithmic combination based on each context.
