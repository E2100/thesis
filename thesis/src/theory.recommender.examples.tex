...
\end{eqsp}
%
where $\hat{r}_{ui}$ is the estimated rating, $R_u$ is the items rated by user $u$, $\mathrm{ratings}(i)$ is the number of ratings for item $i$,
...
In other words, users trust each other's recommendations based on previous experience.
