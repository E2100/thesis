...
In order to test these hypotheses, we performed adaptive prediction aggregation on the two datasets previously described.
...
of our system.
The mean RMSE values of Experiment 1, along with their standard deviation
...
Our adaptive recommenders are adaptive in that each prediction is 
...
so the question whether the extra performance is worth its extra complexity becomes important.
