...
% $Header: /cvsroot-fuse/pgf/pgf/doc/generic/pgf/macros/pgfmanual-en-macros.tex,v 1.50 2011/04/20 17:50:26 matthiasschulz Exp $
...
\newenvironment{parameterdescription}{
  \list{}{\labelwidth=0pt \leftmargin=0.5cm
...
\newenvironment{graph}[1]{
  \begin{pgfmanualentry}
  	\pgfmanualentryheadline{Graph {\ttfamily\declare{#1}}}%
...
\newenvironment{gdalgorithm}[1]{
  \begin{pgfmanualentry}
  	\pgfmanualentryheadline{Graph Drawing Algorithm {\ttfamily\declare{#1}}}%
    \index{#1@\protect\texttt{#1} graph drawing algorithm}%
    \index{Graph Drawing Algorithms!#1@\protect\texttt{#1}}
    \pgfmanualpdflabel{#1}{}%
    \pgfmanualbody
}
{
...
\newenvironment{stylesheet}[1]{
  \begin{pgfmanualentry}
  	\pgfmanualentryheadline{Style sheet {\ttfamily\declare{#1}}}%
