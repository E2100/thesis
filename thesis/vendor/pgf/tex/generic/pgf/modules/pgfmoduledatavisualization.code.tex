...
\ProvidesFileRCS $Header: /cvsroot-fuse/pgf/pgf/generic/pgf/modules/pgfmoduledatavisualization.code.tex,v 1.43 2011/03/14 23:17:52 tantau Exp $
  ...
  \begingroup%
    ...
    \else%
      \expandafter\ifx\csname pgf@dv@group@@\pgf@dv@use@group\endcsname\relax%
        \PackageError{pgf}{Undefined data group '\pgf@dv@use@group'}{}%
      \else%
        {%
...
\def\pgf@datagroup@do@external{%
  ...
  \ifeof\r@pgf@reada\relax
     \PackageError{pgf}{Data file '\pgfkeysvalueof{/pgf/data/read from file}' not found}{}%
  \else
...
\pgfooclass{plot handler visualizer}
{
  ...
  \def\pgf@dv@line@cache@it{
    ...
    \else%
      % An outlier!
      \def\pgf@dv@add{\pgf@dv@outliner}%
    \fi%
